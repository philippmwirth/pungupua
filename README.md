...
| [Pgx: Hardware-Accelerated Parallel Game Simulators for Reinforcement Learning](https://arxiv.org/abs/2303.17503) | Koyamada et al. | 2023 | The `pgx` library providing the JAX-native game environment interface this project builds on |
